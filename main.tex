...
\usepackage{tikz}
\usepackage{wrapfig}
\usepackage[left=2.4cm,right=2.4cm,top=2.4cm,bottom=2.4cm,bindingoffset=1cm]{geometry} % amount of paper lost by binding on each page
% \usepackage{fullpage}
...
\titleformat*{\section}{\LARGE\boifont}

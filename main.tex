...
\documentclass[10pt, a4paper, twoside]{article} % \documentclass{} is the first command in any LaTeX code.  It is used to define what kind of document you are creating such as an article or a book, and begins the document preamble
...
\usepackage{tikz}
\usepackage{wrapfig}
\usepackage[left=2cm,right=2cm,top=2cm,bottom=2cm,bindingoffset=0.5cm]{geometry} % amount of paper lost by binding on each page
% \usepackage{fullpage}
...
\newfontfamily\boifont[Color=Black, Path=./assets/]{boi.otf}
\newfontfamily\markerfont[Color=Black, Path=./assets/]{marker.otf}

\titleformat*{\section}{\huge\markerfont\itshape}
\titleformat*{\subsection}{\Large\boifont}
\titleformat*{\subsubsection}{\large\boifont}
...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \textbf{PDF Booklet Design} – @saneness

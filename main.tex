...
\documentclass[a4paper, twoside]{article} % \documentclass{} is the first command in any LaTeX code.  It is used to define what kind of document you are creating such as an article or a book, and begins the document preamble
...
\usepackage{tikz}
\usepackage{wrapfig}
\usepackage[bindingoffset=7mm]{geometry} % amount of paper lost by binding on each page
% \usepackage{fullpage}
